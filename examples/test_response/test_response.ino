...
uint8_t buf[8];
uint8_t msg[4] = {0x60,0x01,0x14,0x02};
// uint8_t msg[6] = {0x4B,0x41,0x60,0x00,0x34,0x12};
// uint8_t msg[8] = {0x43,0x93,0x60,0x01,0x78,0x56,0x34,0x12};
...
void loop() {
  ...
  if (can_bus.checkReceive()==CAN_MSGAVAIL) {
    ...
    Serial.println();
    can_bus.sendMsgBuf(0x581,0,ARRAY_SIZE(msg),msg);
